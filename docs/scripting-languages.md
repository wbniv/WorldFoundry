...
| *Player not patched: 77 B slot too small for any base64-wrapped wasm (minimum ~108 B). `INDEXOF_CAMSHOT` baked as literal 1021 — wasm3 has no host-side constant import surface.* | | |
