...
`docs/plans/2026-05-03-debug-bridge-gap-features.md` (mailbox-write +
...
- **Engine documentation:**
  - `docs/level-building.md` — mandatory objects, joystick bits, addon-enable order
  - `docs/level-design-troubleshooting.md` — script escaping, MaxAirSpeed, light rotation, Visibility Mailbox semantics, materialIndex pattern, `and`/`or` → `&`/`|` gotcha
  - `docs/scripting-languages.md` — Forth bridge words, mailbox API
  - `docs/reference/2026-04-13-oas-oad-format.md` — OAS schema, OAD field types, button types
  - `docs/investigations/2026-04-29-camera-system.md` — CamShot per-axis Absolute/Relative, runtime switching via `INDEXOF_CAMSHOT`
...
2. **Phase A.5 — per-level cube colors.** Cycle the pyramid's color
   ...
   - Capture MAME attract frames for L2, L3, L4 and pixel-sample the
     arcade's per-level palettes (same method as `docs/plans/2026-05-04-qbert-cube-palette.md`).
...
3. **Phase B — 1 red ball + 1 disc.** Exercises the shipped
   ...
   `docs/2026-05-03-oas-actor-types.md` entries for `Generator`
...
- `docs/plans/2026-05-03-debug-bridge-gap-features.md` — Phase A
