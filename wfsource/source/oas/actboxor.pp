/*============================================================================*/
/* actboxor.ht: created from OADTYPES.S and actboxor.oas DO NOT MODIFY */
/*============================================================================*/
...
#define actboxor_HT
 ...
 struct _"ActBoxOR" {
	...
	int32 "MailBox";               /* Minumum: 2 Maximum: 3999 Default: 100 */		// mailbox to set when activated
	int32 "Object";                               /* index into master object list, = OBJECT_NULL if no reference */
