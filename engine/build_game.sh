...
case "$WF_WASM_ENGINE" in
    wasm3)
        ...
        # Embed selftest.wasm as a byte array (37 bytes; returns i32 42; no imports).
        # Compiled from: (module (func (export "main") (result i32) i32.const 42))
        echo "  GEN wasm_selftest.cc (inline)"
        WASM_CC="$OUT/wasm_selftest.cc"
        cat > "$WASM_CC" << 'SELFTESTCC'
// AUTO-GENERATED by build_game.sh; do not edit.
// selftest.wasm: (module (func (export "main") (result i32) i32.const 42))
...
extern "C" const unsigned int kWasmSelftestLen = 37;
SELFTESTCC
