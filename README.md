...
| 2026-04-16 | [Plan: Android port](docs/plans/2026-04-16-android-port.md) | **In progress — Phases 1+2 done** | Phase 1 ✅ (CMake + NDK toolchain + 64-bit fixes). Phase 2 ✅ ([plan](docs/plans/2026-04-17-android-phase-2.md)): HAL lifecycle hooks + `AssetAccessor` POSIX backend so `DiskFileHD` reads through a platform-swappable seam. GL context hooks deferred to Phase 0. Next: Phase 0 (retire immediate-mode GL) or Phase 3 (Android platform). |
...
**2026-04-17 19:08** — [`docs/plans/2026-04-16-android-port.md`](docs/plans/2026-04-16-android-port.md): Plan: Android port
