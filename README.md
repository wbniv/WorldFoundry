...
| 2026-04-17 | [Plan: Steam release](docs/plans/2026-04-17-steam.md) | **Not started** | **Goal:** Game on Steam — Linux native, Steam overlay, Steam Input for controllers, store page live. ~3–4 days engineering + content work. No GL rewrite required; immediate-mode GL is fine. Steam Deck runs natively (no Proton). |
